...
#include <robots_msgs/SensorState.h>
#include <robots_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const robots_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == robots_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == robots_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const robots_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  robots_msgs::VersionInfo version;
...
int main(int argc, char **argv)
{
  ...
  tb3_version_info_pub = nh.advertise<robots_msgs::VersionInfo>("version_info", 10);
